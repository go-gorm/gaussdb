...
// The error codes to map GaussDB errors to gorm errors, here is the GaussDB error codes reference https://www.gaussdb.org/docs/current/errcodes-appendix.html.
